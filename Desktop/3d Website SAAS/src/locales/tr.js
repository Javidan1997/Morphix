const tr = {
  ...
  configuratorDemo: {
    ...
    title: "Gerçek seçenekler ve satın alma mantığı olan ürünler için özel bir konfigüratör katmanı.",
    copy:
      "Bu demo aynı web deneyiminin farklı ürün kategorilerine nasıl uyarlanabildiğini gösterir. Örnekler arasında geçiş yapın ve müşterilerin kaplamaları, ölçüleri, ekleri ve ortamları tek bir yapılı arayüz içinde nasıl değiştirebildiğini test edin.",
    sidebar: {
      label: "Neleri yönetebilir",
      title: "Farklı konfigürasyona sahip ürün tipleri için tek sistem.",
      copy:
        "Aynı temel akış; mobilya, açık hava sistemleri, aydınlatma, armatürler, ekipman ve sitede yönlendirmeli seçim gerektiren diğer ürünleri destekleyebilir.",
      points: [
        "Boyutlar ve ölçüler",
        "Kaplamalar ve malzemeler",
        "Modüller ve ekler",
        "Ortam geçişleri",
      ],
    },
    delivery: {
      copy:
        "Konfigüratörü prodüksiyona hazır hale getirmek için gereken 3D modelleri, malzemeleri, seçenek eşleştirmesini, render çıktılarını ve Three.js uygulamasını sağlayabiliriz.",
    },
    shell: {
      label: "İnteraktif konfigüratör demosu",
      title: "Tek ürün sistemi, birden fazla kategori, gerçek seçenek kontrolleri.",
      copy:
        "Ürün tipini değiştirin ve aynı web akışının farklı seçenekleri, kaplamaları, ekleri ve ortam görünümlerini nasıl yönettiğini test edin.",
      stageBadge: "İnteraktif önizleme",
      footerPoints: [
        "Kategori geçişi",
        "Seçenek mantığı",
        "Ortam önizlemesi",
        "Web'e hazır asset teslimi",
      ],
    },
  },
  heroConfiguratorProducts: [
    {
      key: "pergola",
      label: "Pergola",
      category: "Açık hava sistemleri",
      previewNote: "Boyut, kaplama, aydınlatma, ekranlar ve ortam.",
      controls: [
        {
          id: "size",
          label: "Boyut",
        ...
        },
        {
          ...
          type: "swatch",
          options: [
            { value: "charcoal", label: "Antrasit", color: "#25303b" },
            { value: "sand", label: "Kum", color: "#d7d3c7" },
            { value: "bronze", label: "Bronz", color: "#8f7f6b" },
          ],
        },
        {
          id: "feature",
          ...
          options: [
            ...
            { value: "fans", label: "Vantilatörler" },
          ],
        },
        {
          id: "environment",
          ...
          options: [
            ...
            { value: "poolside", label: "Havuz kenarı" },
          ],
        },
      ],
    },
    {
      key: "sofa",
      label: "Modüler koltuk",
      category: "Mobilya",
      previewNote: "Modüller, döşeme, ekler ve oda bağlamı.",
      controls: [
        {
          id: "size",
          label: "Yerleşim",
          type: "pill",
          options: [
            { value: "compact", label: "2 kişilik" },
            { value: "standard", label: "3 kişilik" },
            { value: "sectional", label: "L form" },
          ],
        },
        {
          id: "finish",
          ...
          type: "swatch",
          options: [
            { value: "graphite", label: "Grafit", color: "#5a6674" },
            { value: "ivory", label: "Fildişi", color: "#ddd7cf" },
            { value: "olive", label: "Zeytin", color: "#7e8477" },
          ],
        },
        {
          id: "feature",
    ...
    },
    {
      ...
      label: "Sarkıt lamba",
      category: "Aydınlatma",
      previewNote: "Ölçek, kaplama, ışık modu ve sahne geçişi.",
      controls: [
        {
          id: "size",
          label: "Boyut",
        ...
        },
        {
          ...
          type: "swatch",
          options: [
            { value: "black", label: "Siyah", color: "#2b3138" },
            { value: "brass", label: "Pirinç", color: "#b59a63" },
            { value: "stone", label: "Taş", color: "#beb7ae" },
          ],
        },
        {
          id: "feature",
          ...
          options: [
            ...
            { value: "dimmable", label: "Kısılabilir" },
          ],
        },
        {
          id: "environment",
          ...
          options: [
            ...
            { value: "retail", label: "Perakende alanı" },
          ],
        },
      ],
    },
